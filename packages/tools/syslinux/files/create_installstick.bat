@ECHO OFF
TITLE DeKockBlock LIVE USB Installer
...
ECHO.
ECHO.
ECHO                     DeKockBlock LIVE USB Installer
ECHO.
ECHO.
ECHO  *****************************************************************
ECHO.
...
ECHO  *****************************************************************
ECHO.
ECHO                     Installing DeKockBlock to %DRIVE%
...
>NUL copy dekockblock.ico %DRIVE%
...
ECHO  *****************************************************************
ECHO.
ECHO       DeKockBlock failed md5 check - Installation will now quit
ECHO.
ECHO             Your original download is probably corrupt
ECHO       Please visit www.dekockblock.tv and download another copy
ECHO.
ECHO  *****************************************************************
ECHO.
ECHO.
...
ECHO  *****************************************************************
ECHO.
ECHO  The DeKockBlock LIVE USB Installer has been successfully copied to %DRIVE%

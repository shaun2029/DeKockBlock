...
VIAddVersionKey ProductName "DeKockBlock USB Stick Creator"
VIAddVersionKey Comments "A bootable OpenElec Installer Stick creation tool."
VIAddVersionKey CompanyName "DeKockBlock"
VIAddVersionKey LegalCopyright "DeKockBlock"
VIAddVersionKey FileDescription "DeKockBlock USB Stick Creator"
VIAddVersionKey FileVersion "1.0"
VIAddVersionKey ProductVersion "1.0"
VIAddVersionKey InternalName "DeKockBlock USB Stick Creator"

!define PRODUCT_NAME "DeKockBlock USB Stick Creator"
!define PRODUCT_VERSION "1.0"
!define PRODUCT_PUBLISHER "DeKockBlock"
!define PRODUCT_WEB_SITE "http://dekockblock.tv"
BrandingText " "
...
!define MUI_ICON "dekockblock.ico"
!define MUI_WELCOMEFINISHPAGE_BITMAP "welcome.bmp"
!define MUI_ABORTWARNING

!define MUI_WELCOMEPAGE_TITLE "Welcome to the DeKockBlock USB Stick Creator"
!define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the creation of an DeKockBlock USB Installer Stick.\n\nPlease read the following pages carefully."
!insertmacro MUI_PAGE_WELCOME

!define MUI_PAGE_HEADER_TEXT "License Agreement"
!define MUI_PAGE_HEADER_SUBTEXT "Please review the GPLv2 license below before using the DeKockBlock USB Stick Creator"
...
Section "oeusbstart"
  ...
  nsExec::Exec `"$0" /c copy dekockblock.ico $DRIVE_LETTER`
...
!define MUI_FINISHPAGE_TITLE "DeKockBlock USB Stick Successfully Created"
!define MUI_FINISHPAGE_TEXT "An DeKockBlock USB Installer Stick has been created on the device $DRIVE_LETTER.\n\nPlease boot your HTPC off this USB stick and follow the on-screen instructions."
